  ...
  return (
    <main className="h-screen overflow-hidden bg-[#f7f7f5] text-zinc-900">
      <div className="relative flex h-screen flex-col md:flex-row">
        <aside className="z-10 flex h-full w-full shrink-0 flex-col border-r border-zinc-200 bg-[#f5f5f4] md:w-[300px]">
        ...
        <section className="relative h-screen flex-1 overflow-hidden">
